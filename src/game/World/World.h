...
enum eConfigUInt32Values
{
    ...
    CONFIG_TRADE_SKILL_GMIGNORE_MAX_PRIMARY_COUNT,
    CONFIG_TRADE_SKILL_GMIGNORE_LEVEL,
    CONFIG_TRADE_SKILL_GMIGNORE_SKILL,
    ...
    CONFIG_GM_INVISIBLE_AURA,
    CONFIG_GROUP_VISIBILITY,
    CONFIG_MAIL_DELIVERY_DELAY,
    CONFIG_MASS_MAILER_SEND_PER_TICK,
    CONFIG_UPTIME_UPDATE,
    CONFIG_AUCTION_DEPOSIT_MIN,
    ...
    CONFIG_BATTLEGROUND_QUEUE_ANNOUNCER_JOIN,
    CONFIG_ARENA_MAX_RATING_DIFFERENCE,
    CONFIG_ARENA_RATING_DISCARD_TIMER,
    CONFIG_ARENA_AUTO_DISTRIBUTE_INTERVAL_DAYS,
    CONFIG_ARENA_SEASON_ID,
    CONFIG_GROUP_OFFLINE_LEADER_DELAY,
    ...
    CONFIG_GUID_RESERVE_SIZE_CREATURE,
    CONFIG_GUID_RESERVE_SIZE_GAMEOBJECT,
    CONFIG_CREATURE_RESPAWN_AGGRO_DELAY,
    CONFIG_MAX_WHOLIST_RETURNS,
    CONFIG_VALUE_COUNT
};
...
class World
{
    public:
        ...
        bool IsPvPRealm() const { return (getConfig(CONFIG_GAME_TYPE) == REALM_TYPE_PVP || getConfig(CONFIG_GAME_TYPE) == REALM_TYPE_RPPVP || getConfig(CONFIG_GAME_TYPE) == REALM_TYPE_FFA_PVP); }
        bool IsFFAPvPRealm() const { return getConfig(CONFIG_GAME_TYPE) == REALM_TYPE_FFA_PVP; }
    ...
    private:
        ...
        uint32 m_configUint32Values[CONFIG_VALUE_COUNT];
